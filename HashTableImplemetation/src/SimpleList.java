...
public class SimpleList {
    ...
    /**
     * Modified Version of SimpleList
     */
    public void fileOutPut(Duration durationTimeIn) {
		try {
			File fileIn = new File("SimpleListWordCount.txt");
			FileWriter data = new FileWriter(fileIn);
			data.write("Amount of time to get a non-sorted Entries into the HashTable : " + durationTimeIn + "\r\n\n ----------------");
